...
export const EN: Record<string, string> = {
  ...
  "map.offfloor": "{count} connection(s) lead to another floor.",
  "map.connector.up": "{area} · {floor} (above)",
  "map.connector.down": "{area} · {floor} (below)",
  "map.connector.unknown": "{area} · {floor} (no floor level)",
  "map.connector.hint": "click to open the connection, double-click to go to that floor",
  ...
  "enum.preset.ceiling": "Floor / ceiling slab",
