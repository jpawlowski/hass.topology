...
- `entity/` — Base entity class (`TopologyEntity`)
...
- Entity MRO: `(PlatformEntity, TopologyEntity)` — order matters
...
- Debug level: `custom_components.topology: debug` in `config/configuration.yaml`
