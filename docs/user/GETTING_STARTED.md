...
This guide will help you install and set up the Topology custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/jpawlowski/hass.topology`
6. Set category to "Integration"
7. Click "Add"
8. Find "Topology" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/jpawlowski/hass.topology/releases)
2. Extract the `topology` folder from the archive
3. Copy it to `custom_components/topology/` in your Home Assistant configuration directory
...
4. Select entities from "Topology"
...
- Report issues at [GitHub Issues](https://github.com/jpawlowski/hass.topology/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/jpawlowski/hass.topology/discussions)
