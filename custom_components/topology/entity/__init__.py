"""
Entity package for topology.

Architecture:
    All platform entities inherit from (PlatformEntity, TopologyEntity).
...
See entity/base.py for the TopologyEntity base class.
"""

from .base import TopologyEntity

__all__ = ["TopologyEntity"]
