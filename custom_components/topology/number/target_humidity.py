"""Target humidity number for topology."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.topology.api import TopologyApiClientError
...
class TopologyHumidityNumber(NumberEntity, TopologyEntity):
