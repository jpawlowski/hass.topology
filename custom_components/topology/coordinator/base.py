"""
Core DataUpdateCoordinator implementation for topology.
...
from custom_components.topology.api import (
    TopologyApiClientAuthenticationError,
    TopologyApiClientError,
)
from custom_components.topology.const import LOGGER
...
class TopologyDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except TopologyApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="topology",
                translation_key="authentication_failed",
            ) from exception
        except TopologyApiClientError as exception:
